...
def get_config():
    ...
    train.epsilon = 0.2
    # whether to scale rewards within groups
    train.scale_rewards = True
    # whether to use reference model
    train.use_reference_model = True
    # mixing coefficient for reference model updates
    train.reference_model_mixup_alpha = 0.5
    # frequency of reference model updates (in epochs)
    train.reference_update_freq = 1
